...
public class RobotContainer {
    ...
    private final Trigger leftTrigger = new Trigger(
            () -> xbox.getRawAxis(XboxController.Axis.kLeftTrigger.value) > 0.4
    );

    // Convert dPad up and down to buttons
    ...
    private RobotContainer() {
        ...
        m_turret.setDefaultCommand(new RunCommand(() -> m_turret.setElevation(xbox.getRawAxis(XboxController.Axis.kRightTrigger.value)), m_turret));
    ...
    private void configureButtonBindings() {
        ...
        xButton
            .whenPressed(new InstantCommand(m_grabber::extend, m_grabber))
            .whenReleased(new InstantCommand(m_grabber::retract, m_grabber));
        ...
        rightBumper
            .whenPressed(new InstantCommand(() -> m_driveTrain.setReversed(true), m_driveTrain))
            .whenReleased(new InstantCommand(() -> m_driveTrain.setReversed(false), m_driveTrain));

        leftTrigger
            .whenActive(new InstantCommand(() -> m_driveTrain.setSpeedModifier(0.5), m_driveTrain))
            .whenInactive(new InstantCommand(() -> m_driveTrain.setSpeedModifier(1), m_driveTrain));

        startButton
            .whenPressed(new InstantCommand(m_driveTrain::brake, m_driveTrain));
        backButton
            .whenPressed(new InstantCommand(m_driveTrain::coast, m_driveTrain));

        dPadUp
            .whenActive(new InstantCommand(m_turret::enableVisionLights, m_turret));
        dPadDown
            .whenActive(new InstantCommand(m_turret::disableVisionLights, m_turret));
    }
