...
private final Joystick leftJoystick = new Joystick(0);
    ...
    // SmartDashboard.putData("RunShooter", new RunShooter( m_shooter ));
...
// Create some buttons
final JoystickButton button3 = new JoystickButton(buttonBox, 3);        
button3.whenPressed(new RunShooter(1, m_shooter) ,true);
    SmartDashboard.putData("Button3",new RunShooter(1, m_shooter) );

final JoystickButton button2 = new JoystickButton(buttonBox, 2);        
button2.whenPressed(new RunShooter(0.5, m_shooter) ,true);
    SmartDashboard.putData("Button2",new RunShooter(0.5, m_shooter) );

final JoystickButton button1 = new JoystickButton(buttonBox, 1);        
button1.whenPressed(new RunShooter(0, m_shooter) ,true);
    SmartDashboard.putData("Button1",new RunShooter(0, m_shooter) );
