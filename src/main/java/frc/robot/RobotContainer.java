...
full.whileHeld(new FlywheelOutput(0, m_flywheel) ,true);
    SmartDashboard.putData("Full",new FlywheelOutput(0, m_flywheel) );

final JoystickButton half = new JoystickButton(buttonBox, 2);        
half.whileHeld(new FlywheelOutput(0, m_flywheel) ,true);
    SmartDashboard.putData("Half",new FlywheelOutput(0, m_flywheel) );

final JoystickButton off = new JoystickButton(buttonBox, 1);        
off.whileHeld(new FlywheelOutput(0, m_flywheel) ,true);
