...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("FlywheelOutput", new FlywheelOutput( 0, m_flywheel));
    SmartDashboard.putData("JoystickFlywheel", new JoystickFlywheel( false, m_flywheel));
    ...
    private void configureButtonBindings() {
        //button box extra button 
        final JoystickButton shiftToFlywheel = new JoystickButton(buttonBox, 4);
        shiftToFlywheel.whileHeld(new JoystickFlywheel(true, m_flywheel), true);
        SmartDashboard.putData("ShiftToFlywheel", new JoystickFlywheel(true, m_flywheel));

        //button box toggle speed buttons
        final JoystickButton full = new JoystickButton(buttonBox, 3);
        full.whenPressed(new FlywheelOutput(1, m_flywheel), true);
        SmartDashboard.putData("Full", new FlywheelOutput(1, m_flywheel));

        final JoystickButton half = new JoystickButton(buttonBox, 2);
        half.whenPressed(new FlywheelOutput(0.5, m_flywheel), true);
        SmartDashboard.putData("Half", new FlywheelOutput(0.5, m_flywheel));

        final JoystickButton off = new JoystickButton(buttonBox, 1);
        off.whenPressed(new FlywheelOutput(0, m_flywheel), true);
        SmartDashboard.putData("Off", new FlywheelOutput(0, m_flywheel));

        //reverse drivetrain buttons
