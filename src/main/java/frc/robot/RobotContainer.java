...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("Shooter", new Shooter( m_flywheelShooter ));
...
// Create some buttons
final JoystickButton shooterBtn = new JoystickButton(rightJoystick, 1);        
shooterBtn.whileHeld(new Shooter( m_flywheelShooter ) ,true);
    SmartDashboard.putData("ShooterBtn",new Shooter( m_flywheelShooter ) );
