...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("RunShooterC1", new RunShooterC1( m_shooter ));
    // SmartDashboard.putData("RunShooterC2", new RunShooterC2( m_shooter ));
    SmartDashboard.putData("RunShooterC3", new RunShooterC3( m_shooter ));
    // SmartDashboard.putData("HoldVelocity", new HoldVelocity( m_shooter ));
...
// Create some buttons
final JoystickButton button4 = new JoystickButton(buttonBox, 6);        
button4.whenHeld(new HoldVelocity(10, m_shooter) ,true);
    SmartDashboard.putData("Button4",new HoldVelocity(10, m_shooter) );

final JoystickButton button3 = new JoystickButton(buttonBox, 5);        
button3.whenHeld(new RunShooterC3( m_shooter ) ,true);
    SmartDashboard.putData("Button3",new RunShooterC3( m_shooter ) );

final JoystickButton button2_2 = new JoystickButton(buttonBox, 4);        
button2_2.whenPressed(new RunShooterC2(1, m_shooter) ,true);
    SmartDashboard.putData("Button2_2",new RunShooterC2(1, m_shooter) );

final JoystickButton button2_1 = new JoystickButton(buttonBox, 3);        
button2_1.whenPressed(new RunShooterC2(0.5, m_shooter) ,true);
    SmartDashboard.putData("Button2_1",new RunShooterC2(0.5, m_shooter) );

final JoystickButton button2_0 = new JoystickButton(buttonBox, 2);        
button2_0.whenPressed(new RunShooterC2(0, m_shooter) ,true);
    SmartDashboard.putData("Button2_0",new RunShooterC2(0, m_shooter) );

final JoystickButton button1 = new JoystickButton(buttonBox, 1);        
button1.whenPressed(new RunShooterC1( m_shooter ) ,true);
    SmartDashboard.putData("Button1",new RunShooterC1( m_shooter ) );
