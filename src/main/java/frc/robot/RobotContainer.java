...
// The robot's subsystems
    public final FlyWheelShooter m_flyWheelShooter = new FlyWheelShooter();
    public final TurrentRotation m_turrentRotation = new TurrentRotation();
...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData(m_turrentRotation);
    ...
    SmartDashboard.putData("RotateTurrent", new RotateTurrent( m_turrentRotation ));
    SmartDashboard.putData("Shooter Flywheel", new ShooterFlywheel( m_flyWheelShooter ));
    ...
    m_turrentRotation.setDefaultCommand(new RotateTurrent( m_turrentRotation ) );
...
topPressed.whenPressed(new SetGrabberExtended(true, m_grabber) ,true);
    SmartDashboard.putData("TopPressed",new SetGrabberExtended(true, m_grabber) );

final JoystickButton flyWheelButton = new JoystickButton(leftJoystick, 1);        
flyWheelButton.toggleWhenPressed(new ShooterFlywheel( m_flyWheelShooter ) ,true);
    SmartDashboard.putData("FlyWheel Button",new ShooterFlywheel( m_flyWheelShooter ) );
